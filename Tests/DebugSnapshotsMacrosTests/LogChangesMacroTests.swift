  ...
  @Suite(
    .macros(
      [
        ...
        "LogChangesIgnored": LogChangesIgnoredMacro.self,
      ],
      record: .failed
    )
  )
        ...
        class Model {
          ...
          func incrementButtonTapped() {
            ...
            defer {
              let next = DebugSnapshots.snap(self)
              DebugSnapshots._logChanges(
                __macro_local_4snapfMu_, next, quiet: __macro_local_6calledfMu_, line: __macro_local_6calledfMu_ ? 7 : 5
              )
            }
            #else
            @_transparent
        ...
        class Model {
          func fetch() async throws -> Int {
            ...
            defer {
              let next = DebugSnapshots.snap(self)
              DebugSnapshots._logChanges(
                __macro_local_4snapfMu_, next, quiet: __macro_local_6calledfMu_, line: __macro_local_6calledfMu_ ? 6 : 4
              )
            }
            #else
            @_transparent
        ...
        class Model {
          ...
          func incrementButtonTapped() {
            ...
            defer {
              let next = DebugSnapshots.snap(self)
              DebugSnapshots._logChanges(
                __macro_local_4snapfMu_, next, quiet: __macro_local_6calledfMu_, line: __macro_local_6calledfMu_ ? 9 : 5
              )
            }
            #else
            @_transparent
